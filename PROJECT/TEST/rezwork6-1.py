...
# EQmas{ id: ([tme, [[Ask1, Bid1],   [Ask2, Bid2], [Ask1f, Bid1f], [Ask2f, Bid2f]],   REZ,status]) }
...
for id in EQmas:
	...
	for eq in EQmas[id ][0:]:
		...
		if pos != None:
			...
			if pos == 'buy':
				Reqprofrez1 = (nakprofrez1 + 100 * (eBid1 - buyopenprice1)/buyopenprice1)
				Reqprofrez2 = (nakprofrez2 + 100 * (sellopenprice2 - eAsk2)/sellopenprice2)

				Reqprofrez1f = (nakprofrez1f + 100 * (eBid1f - buyopenprice1f)/buyopenprice1f)
				Reqprofrez2f = (nakprofrez2f + 100 * (sellopenprice2f - eAsk2f)/sellopenprice2f)



			elif pos == 'sell':
				Reqprofrez1 = (nakprofrez1 + 100 * (sellopenprice1 - eAsk1)/sellopenprice1)
				Reqprofrez2 = (nakprofrez2 + 100 * (eBid2 - buyopenprice2)/buyopenprice2)

				Reqprofrez1f = (nakprofrez1f + 100 * (sellopenprice1f - eAsk1f)/sellopenprice1f)
				Reqprofrez2f = (nakprofrez2f + 100 * (eBid2f - buyopenprice2f)/buyopenprice2f)
