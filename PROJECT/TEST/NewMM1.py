				...
				if data[sym1]['tmstp'][2] and data[sym2]['tmstp'][2]:
					...
					if sredn1 != None and sredn2 != None:
						...
						if So != None:
							...
							# покупка
							# if timesellvih==tme :
							# 	print('buy ', flagbuy and Asksp < SoBid * ksovh and  So > minkso and totrade)
							# 	print(f'flagbuy {flagbuy}')
							# 	print(f' Asksp < SoBid * ksovh{Asksp < SoBid * ksovh}')
							# 	print(f'So > minkso {So > minkso}')
							# 	print(f'totrade {totrade}')
							...
							# продажа
							# if timebuyvih ==tme:
							# 	print('sell ',flagsell and Bidsp > SoAsk * ksovh and  So > minkso and totrade)
							# 	print(f'flagsell  {flagsell }')
							# 	print(f'Bidsp > SoAsk * ksovh {Bidsp > SoAsk * ksovh}')
							# 	print(f' So > minkso  { So > minkso }')
							# 	print(f'totrade {totrade}')
