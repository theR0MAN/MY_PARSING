	...
	try:
		...
		if hour0 != hour:
			...
			for onetwo, persr, kperso, ksovh, koefvih in itertools.product(onetwomas, persrs, kpersos, ksovhs, koefvihs):
				...
				EQ.append([tme, [[dAsk[sym1], dBid[sym1]], [dAsk[sym2], dBid[sym2]], [dAskf[sym1], dBidf[sym1]], [dAskf[sym2], dBidf[sym2]]], REZ])
				REZ = []
				...
				fixprof1.append(nakprofrez1[id])
				fixprof2.append(nakprofrez2[id])
