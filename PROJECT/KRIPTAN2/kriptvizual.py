...
start_year, start_month, start_day, start_hour = 2024, 1, 3, 21
stop_year, stop_month, stop_day, stop_hour = 2024, 1, 3, 22
		...
		for instfull in data:
			...
			if instr in rezdict:
				if data[instfull]['dat'] != None:
					rezdict[instr][instfull]['asks'].append (data[instfull]['dat'][0])
					rezdict[instr][instfull]['bids'].append(data[instfull]['dat'][1])
				else:
